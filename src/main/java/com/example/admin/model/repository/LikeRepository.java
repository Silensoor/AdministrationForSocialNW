...
import com.example.admin.model.Like;
...
public class LikeRepository {
    ...
    public List<Like> findLikesByPersonId(Long id){
        return jdbcTemplate.query("select * from likes where person_id = ?",likeRowMapper,id);
    }
