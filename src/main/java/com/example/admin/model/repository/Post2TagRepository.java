...
import com.example.admin.model.Post2Tag;
import com.example.admin.model.Tag;
...
public class Post2TagRepository {
    ...
    public void deleteTegById(Long id){
        jdbcTemplate.update("delete from tags where id = ?",id);
    }
    public void deletePost2TagByPostId(Long id){
        jdbcTemplate.update("delete from post2tag where post_id = ?",id);
    }
